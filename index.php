...
<link href='//fonts.googleapis.com/css?family=Amiri:400i|Noto+Serif:400i,700i|Armata' rel='stylesheet' type='text/css'>
...
<body>
   ...
   <div class="wrapper">
      ...
      <h1 id="main-title" class="header">Robot psychanalytique <button id="more-infos" class="btn-invisible icon-help"><span class="hide">À propos</span></button></h1>
      ...
      <div class="light-modal-content animated zoomIn">
         ...
         <div class="light-modal-footer">
            ...
            <p>Par <a href="https://juliabr.com">Julia Briend</a> | <a href="https://github.com/juliabr/Psybot" class="icon-github">Voir sur GitHub</a></p>
